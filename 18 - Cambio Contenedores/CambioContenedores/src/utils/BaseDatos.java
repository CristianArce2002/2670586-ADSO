...
public class BaseDatos {
        ...
        try {
            ...
            if (registros.getRow()==1) {
                ...
                do{
                    ...
                    arreglo[i] = new Persona(cedula, nombres, telefono, email);
                    i++;
                }while(registros.next());
    ...
    public boolean insertarPersona(String cedula, String nombres, String telefono, String email){
        boolean respuesta = false;
        try {
            String consulta = "INSERT INTO personas (cedula, nombres, telefono, email) VALUES ('"+cedula+"','"+nombres+"','"+telefono+"','"+email+"')";
    ...
    public boolean actualizarPersona(String cedula, String nombres, String telefono, String email){
        boolean respuesta = false;
        try {
            String consulta = "UPDATE personas SET nombres='"+nombres+"', telefono='"+telefono+"', email='"+email+"' WHERE cedula='"+cedula+"'";
            int resp_consulta = manipularDB.executeUpdate(consulta);
            if (resp_consulta==1) {
                respuesta = true;
            }
